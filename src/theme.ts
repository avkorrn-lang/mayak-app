...
export const Fonts = { title: { fontSize:24, fontWeight:'700' as const }, subtitle: { fontSize:16, fontWeight:'400' as const, lineHeight:24, marginBottom:24 }, body: { fontSize:15 } };
